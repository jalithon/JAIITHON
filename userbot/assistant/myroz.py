...
# ===============================================================
#    جميع الحقوق لمطوري سورس جليثون حصريا لهم فقط
...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [
                    Button.url("• المطـور •", "https://t.me/XRZOC"),
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("• تنصيب جليثون •", data="deploy")],
                [Button.url("• المساعدة  •", "https://t.me/GroupJalithon")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "https://t.me/JJSQR")],
                [Button.url("كروب المساعدة ❓", "https://t.me/GroupJalithon")],
            ],
        )
